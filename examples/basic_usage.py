...
from ps3toolbox import decrypt_ps2_iso
from ps3toolbox import encrypt_ps2_iso
from ps3toolbox import extract_metadata


def example_encrypt():
    """Example: Encrypt a PS2 ISO."""
    encrypt_ps2_iso(Path("game.iso"), Path("game.iso.enc"), mode="cex")
    print("Encryption complete!")


def example_decrypt():
    """Example: Decrypt an encrypted PS2 Classic."""
    decrypt_ps2_iso(Path("game.iso.enc"), Path("game_decrypted.iso"), mode="cex")
...
def example_with_progress():
    ...
    encrypt_ps2_iso(Path("game.iso"), Path("game.iso.enc"), mode="cex", progress_callback=progress_callback)
